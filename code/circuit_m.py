...
MDD = True #decrease PN GtonicApic and MN2PN weight by 40%
...
reduce_inhib = .4 # %reduction in inhibition
...
if TESTING:
	...
	OUTPUTPATH = '/scratch/e/etayhay/frankm/Mazza2021_output/Depression/'
